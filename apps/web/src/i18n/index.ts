...
const zh: Dict = {
  ...
  'topbar.modelCustomPlaceholder': '填模型名，留空用服务端默认',
  'topbar.advanced': '高级设置',
  'topbar.tagRec': '够用',
  'topbar.tagMax': '最强',
  ...
  // Command palette（⌘K 画廊 + 文档搜索）
  'palette.search': '搜索',
  'palette.placeholder': '搜索导图与文档…',
  'palette.results': '{n} 个结果',
  'palette.maps': '导图',
  'palette.documents': '文档',
  'palette.recentMaps': '最近的导图',
  'palette.recentDocuments': '最近的文档',
  'palette.nodes': '{n} 个节点',
  'palette.statusIndexed': '已索引',
  'palette.statusIndexing': '索引中',
  'palette.statusUnindexed': '未索引',
  'palette.attached': '已附加',
  'palette.attach': '附加',
  'palette.detach': '取消附加',
  'palette.open': '打开',
  'palette.opened': '已打开「{title}」',
  'palette.emptyGalleryTitle': '画廊还是空的',
  'palette.emptyGalleryDesc': '生成或导入一张思维导图后，它会自动出现在这里，⌘K 即可随时切回。',
  'palette.noMatchTitle': '没有匹配「{q}」的结果',
  'palette.noMatchDesc': '画廊和文档里都没有匹配项。换个关键词，或从这条查询新建一张图。',
  'palette.newMapFrom': '从「{q}」新建导图',
  'palette.seedHint': '在左侧对话框输入你的目标即可生成',
  'palette.kbdNav': '选择',
  'palette.kbdEnter': '打开 · 附加',
  'palette.kbdPreview': '预览',
  'palette.attachedCount': '已附加 {n} 篇',
  ...
  'conv.errorQuotaTitle': '免费体验额度已用完',
  'conv.errorQuotaDesc': '今天的免费试用次数已用尽。填入你自己的 API Key 即可不限量继续——Key 只存在你的浏览器里。',
  'conv.errorQuotaAction': '填入我的 Key',
...
const en: Dict = {
  ...
  'topbar.modelCustomPlaceholder': 'Model name, blank = server default',
  ...
  // Command palette (⌘K gallery + document search)
  'palette.search': 'Search',
  'palette.placeholder': 'Search maps and documents…',
  'palette.results': '{n} results',
  'palette.maps': 'Maps',
  'palette.documents': 'Documents',
  'palette.recentMaps': 'Recent maps',
  'palette.recentDocuments': 'Recent documents',
  'palette.nodes': '{n} nodes',
  'palette.statusIndexed': 'indexed',
  'palette.statusIndexing': 'indexing',
  'palette.statusUnindexed': 'not indexed',
  'palette.attached': 'attached',
  'palette.attach': 'Attach',
  'palette.detach': 'Detach',
  'palette.open': 'Open',
  'palette.opened': 'Opened "{title}"',
  'palette.emptyGalleryTitle': 'Your gallery is empty',
  'palette.emptyGalleryDesc': 'Generate or import a mind map and it lands here automatically — ⌘K to jump back anytime.',
  'palette.noMatchTitle': 'No matches for "{q}"',
  'palette.noMatchDesc': 'Nothing in your gallery or documents matches. Try another keyword, or start a new map from this query.',
  'palette.newMapFrom': 'New map from "{q}"',
  'palette.seedHint': 'Type your goal in the chat on the left to generate it',
  'palette.kbdNav': 'navigate',
  'palette.kbdEnter': 'open · attach',
  'palette.kbdPreview': 'preview',
  'palette.attachedCount': '{n} attached',
  ...
  'conv.errorQuotaTitle': 'Free demo limit reached',
  'conv.errorQuotaDesc': 'You\'ve used up today\'s free runs. Add your own API key to keep going, unlimited — it stays in your browser.',
  'conv.errorQuotaAction': 'Add my key',
