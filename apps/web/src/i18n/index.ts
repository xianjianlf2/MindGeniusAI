...
const zh: Dict = {
  ...
  'canvas.exportMermaid': 'Mermaid 图',
  'canvas.exported': '已导出 {file}',
  'canvas.shortcuts': '快捷键',
  'canvas.closeShortcuts': '关闭快捷键面板',
  'shortcut.addChild': '加子节点',
  'shortcut.addSibling': '加兄弟节点',
  'shortcut.rename': '重命名',
  'shortcut.delete': '删除节点',
  'shortcut.undo': '撤销',
  'shortcut.redo': '重做',
  'shortcut.multiSelect': '框选多个',
  'shortcut.edit': '双击编辑',
  'shortcut.reparent': '拖到节点上＝改父',
  'canvas.newMap': '新建画布',
  'canvas.newMapConfirm': '清空当前思维导图并新建？此操作无法撤销。',
  'canvas.import': '导入',
  'canvas.imported': '已导入 {file}',
  'canvas.importEmpty': '未能从该文件解析出思维导图',
  'canvas.importFailed': '导入失败：文件格式无法识别',
...
const en: Dict = {
  ...
  'canvas.exportMermaid': 'Mermaid diagram',
  'canvas.exported': 'Exported {file}',
  'canvas.shortcuts': 'Shortcuts',
  'canvas.closeShortcuts': 'Close shortcuts panel',
  ...
  'shortcut.undo': 'Undo',
  'shortcut.redo': 'Redo',
  'shortcut.multiSelect': 'Multi-select',
  'shortcut.edit': 'Edit',
  'shortcut.reparent': 'Drag onto a node = re-parent',
  'canvas.newMap': 'New map',
  'canvas.newMapConfirm': 'Clear the current mind map and start a new one? This can\'t be undone.',
  'canvas.import': 'Import',
  'canvas.imported': 'Imported {file}',
  'canvas.importEmpty': 'No mind map could be parsed from that file',
  'canvas.importFailed': 'Import failed: unrecognized file format',
